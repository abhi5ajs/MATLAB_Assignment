function [original_pic, salt, gau, mynoise] = Trial(fname1, fname2, fname3, m, d, var_gauss)
...
% For e.g., in our case: 
%'fname1.jpg' = 'figure_1.jpg'; %'fname2.jpg' = 'fname_3.jpg'; 'fname3.jpg' = 'fname_4.jpg'

Image_1 = imread('fname1.jpg'); Image_2 = imread('fname2.jpg'); Image_3 = imread('fname3.jpg'); 
...
% Creating a high and low noise density (d); Default = 0.05  
% To create guassian effect with high & low mean (m); Default = 0
% TO create guassian effect with high & Low variance (var_gauss); Default = 0.01 
figure(7);
%1 Original Pic
subplot(2,2,1);
